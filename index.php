...
<head>
    ...
    <link rel="icon" href="images/logo.png" sizes="32x32"> <!-- Standard size -->
    <link rel="icon" href="images/logo.png" sizes="192x192"> <!-- For larger displays -->
    <link rel="apple-touch-icon" href="images/logo.png">
    <link rel="icon" href="images/logo.png">
    <title>FoodMania–Your Ultimate Culinary Experience</title>
        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/food logo.png" alt="" alt="" style="width: 75px; height:auto;"> </a>
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"> <a class="nav-link active" href="index.php">Foodmania <span class="sr-only">(current)</span></a> </li>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>KPHB colony near metro pillar no 345,Hyderabad 500001,Telangana</p>
                                    <h5>Phone: +91 9849437624</a></h5> </div>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                    <h5>Addition informations</h5>
                                   <p>Join thousands of other restaurants who benefit from having partnered with us.</p>
                                </div> 
                                <div class="container text-center">
        <span class="text-muted">© 2024 FoodMania. All rights reserved.</span>
    </div>
                    </div>
                </div>
            </div>
